...
<div id="q1" class="question-container active">
        <h2>Question 1: In the event of a fire, the doors to stair tower must be closed to prevent the spread of fire by what?</h2>
        <ul class="answers">
            <li><input type="radio" id="q1a" name="q1" data-correct="true"><label for="q1a">A) Convection</label></li>
            <li><input type="radio" id="q1b" name="q1"><label for="q1b">B) Conduction</label></li>
            <li><input type="radio" id="q1c" name="q1"><label for="q1c">C) Radiation</label></li>
            <li><input type="radio" id="q1d" name="q1"><label for="q1d">D) Ventilation</label></li>
        </ul>
        <div class="buttons">
...
<div id="q11" class="question-container">
        <h2>Question 11: What is the colour coding of portable Water Extinguisher?</h2>
        <ul class="answers">
            <li><input type="radio" id="q11a" name="q11"><label for="q11a">A) White</label></li>
            <li><input type="radio" id="q11b" name="q11"><label for="q11b">B) Black</label></li>
            <li><input type="radio" id="q11c" name="q11"><label for="q11c">C) Yellow</label></li>
            <li><input type="radio" id="q11d" name="q11" data-correct="true"><label for="q11d">D) Signal Red</label></li>
        </ul>
        <div class="buttons">
            <button onclick="previousQuestion()">« Previous</button>
            <button onclick="nextQuestion()">Next »</button>
...
<div id="q15" class="question-container">
        <h2>Question 15: What is the duration of SCBA Bottle for 1200 LTRS?</h2>
        <ul class="answers">
            <li><input type="radio" id="q15a" name="q15"><label for="q15a">A) 15 Min.</label></li>
            <li><input type="radio" id="q15b" name="q15"><label for="q15b">B) 20 Min.</label></li>
            <li><input type="radio" id="q15c" name="q15" data-correct="true"><label for="q15c">C) 30 Min.</label></li>
            <li><input type="radio" id="q15d" name="q15"><label for="q15d">D) 45 Min</label></li>
        </ul>
        <div class="buttons">
            <button onclick="previousQuestion()">« Previous</button>
            <button onclick="nextQuestion()">Next »</button>
