...
<style>
 ...
 <div id="q1" class="question-container">
        ...
        <ul class="answers">
            <li><input type="radio" id="q1a" name="q1" data-correct="true"><label for="q1a">A) Larynx</label></li>
            <li><input type="radio" id="q1b" name="q1"><label for="q1b">B) Trachea</label></li>
            <li><input type="radio" id="q1c" name="q1"><label for="q1c">C) Epiglottis</label></li>
...
<div id="q15" class="question-container">
        <h2>Question 15: If there is no response from the crew when you are doing the primary survey, you should:</h2>
        <ul class="answers">
            <li><input type="radio" id="q15a" name="q15" data-correct="true"><label for="q15a">A) Call 108 and return to the crew</label></li>
            <li><input type="radio" id="q15b" name="q15"><label for="q15b">B) Give rescue breaths</label></li>
            <li><input type="radio" id="q15c" name="q15"><label for="q15c">C) Check for a pulse</label></li>
